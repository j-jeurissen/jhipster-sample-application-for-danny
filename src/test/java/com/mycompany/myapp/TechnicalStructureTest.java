...
@AnalyzeClasses(packagesOf = JhipsterSampleApplicationForDannyApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterSampleApplicationForDannyApp.class), alwaysTrue())
