...
@RestController
@RequestMapping("/api/jhipster-sample-application-for-danny-kafka")
public class JhipsterSampleApplicationForDannyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationForDannyKafkaResource.class);
    ...
    public JhipsterSampleApplicationForDannyKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
